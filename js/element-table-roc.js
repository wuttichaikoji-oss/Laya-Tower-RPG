...
(function () {
  ...
  const strongAgainst = { Fire:["Wind","Undead"], Water:["Fire"], Wind:["Water"], Earth:["Wind"], Holy:["Shadow","Undead"], Shadow:["Holy"], Ghost:["Poison"], Poison:["Holy"], Undead:["Poison"], Neutral:[] };
  const weakAgainst = { Fire:["Water"], Water:["Wind"], Wind:["Earth"], Earth:["Fire"], Holy:["Poison","Shadow"], Shadow:["Holy"], Ghost:["Holy"], Poison:["Ghost","Undead"], Undead:["Fire","Holy"], Neutral:[] };
  function getMultiplier(attackerElement, defenderElement, attackerLevel = 1, defenderLevel = 1) {
    ...
    if ((attackerElement === "Poison" && defenderElement === "Undead") || (attackerElement === "Undead" && defenderElement === "Ghost")) return 0;
    let multiplier = 1;
